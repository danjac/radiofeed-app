...
`
    ...
    y(
        "refs",
        (e) => (
            e._x_refs_proxy || (e._x_refs_proxy = D(ai(e))), e._x_refs_proxy
        )
    );
    function ai(e) {
        let t = [],
    ...
    p(
        ...
        (
            e,
            { expression: t },
            { effect: r, evaluate: n, evaluateLater: i }
        ) => {
            let o = i(t),
                s = () => {
                    let u;
    ...
    p(
        ...
        (e, { modifiers: t, expression: r }, { effect: n, cleanup: i }) => {
            ...
            let l = pi(e, t, r),
                u = de(e, c, t, (x) => {
                    a(() => {}, {
                        scope: { $event: x, rightSideOfExpression: l },
                    });
                });
            i(() => u());
