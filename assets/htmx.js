    ...
    return (function () {
        ...
        function He(e, t) {
            ...
            if (r) {
                try {
                    ...
                    ot(P().body, "htmx:eventFilter:error", {
                        error: e,
                        source: r.source,
                    });
                    return true;
        ...
        function qt(t, r, n, e, i) {
            ...
            if (Rt(e)) {
                ...
                var a = e.value;
                if (e.multiple) {
                    a = p(e.querySelectorAll("option:checked")).map(function (
                        e
                    ) {
                        return e.value;
                    });
        ...
        function Mt(e) {
            var t = X(e, "hx-swap");
            var r = {
                swapStyle: j(e).boosted
                    ? "innerHTML"
                    : D.config.defaultSwapStyle,
        ...
        function Dt(t, r, n) {
            ...
            if (i != null) {
                ...
                if (
                    X(r, "hx-encoding") === "multipart/form-data" ||
                    (v(r, "form") && c(r, "enctype") === "multipart/form-data")
                ) {
                    return Ht(n);
                } else {
                    return At(n);
        ...
        function Zt(e, t, n, r, i) {
            ...
            if (v) {
                ...
                if (
                    g === null ||
                    !lt(n, "htmx:prompt", { prompt: g, target: l })
                ) {
                    U(o);
                    d();
                    return s;
            ...
            var q = {
                ...
                errors: b,
                withCredentials:
                    i.credentials || R.credentials || D.config.withCredentials,
            ...
            var I = {
                ...
                target: l,
                requestConfig: q,
                pathInfo: { path: t, finalPath: A, anchor: T },
            };
            m.onload = function () {
                try {
                    var e = Jt(n);
                        ...
                        var o = function () {
                            ...
                            if (c) {
                                var e =
                                    ...
                                    s.pathInfo.path;
                                pt(e);
                                lt(P().body, "htmx:pushedIntoHistory", {
                                    path: e,
                                });
                            }
                            Pt(r.elts, d);
