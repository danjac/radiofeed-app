...
class TestFavicon:
    def test_get(self, db, client, assert_ok):
...
class TestAboutPages:
    def test_faq(self, db, client, assert_ok):
        assert_ok(client.get(reverse("about:faq")))

    def test_credits(self, db, client, assert_ok):
        assert_ok(client.get(reverse("about:credits")))

    def test_shortcuts(self, db, client, assert_ok):
        assert_ok(client.get(reverse("about:shortcuts")))

    def test_terms(self, db, client, assert_ok):
        assert_ok(client.get(reverse("about:terms")))


class TestAcceptCookies:
    def test_post(self, client, db, assert_ok):
...
class TestErrorPages:
    def test_bad_request(self, db, client, assert_ok):
        assert_ok(client.get(reverse("error:bad_request")))

    def test_not_found(self, db, client, assert_ok):
        assert_ok(client.get(reverse("error:not_found")))

    def test_forbidden(self, db, client, assert_ok):
        assert_ok(client.get(reverse("error:forbidden")))

    def test_not_allowed(self, db, client, assert_ok):
        assert_ok(client.get(reverse("error:not_allowed")))

    def test_server_error(self, db, client, assert_ok):
        assert_ok(client.get(reverse("error:server_error")))

    def test_csrf(self, db, client, assert_ok):
