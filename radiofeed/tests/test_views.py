...
from radiofeed.tests.asserts import assert_client_error, assert_ok
...
class TestCoverImage:
    ...
    def test_missing_url_param(self, client, db, mocker):
        assert_client_error(client.get(reverse("cover_image", kwargs={"size": 100})))

    @pytest.mark.django_db()
    def test_unsigned_url(self, client, db):
        assert_client_error(client.get(self.get_url(100, self.cover_url)))
