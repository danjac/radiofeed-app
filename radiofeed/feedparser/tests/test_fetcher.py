...
from radiofeed.feedparser.fetcher import build_http_headers, fetch, make_content_hash
...
class TestFetch:
    def test_fetch_ok(self):
        ...
        response = fetch(client, "http://example.com")
    ...
    def test_fetch_not_modified(self):
        ...
        with pytest.raises(NotModifiedError):
            fetch(client, "http://example.com", etag="123")
