...
class TestFeedParser:
    ...
    def test_parse_ok(self, categories):
        ...
        assert (
            ...
            == "mysterious universe blog specializing offbeat th kind science science medicine religion spirituality society culture social science spirituality philosophy mu tibetan zombie mu saber tooth tiger king mu kgb cop mu joshua cutchin timothy renner mu squid router mu jim bruton"
        )
