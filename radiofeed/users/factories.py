...
from radiofeed.common.factories import NotSet, default_sequence, set_default
...
def create_user(
    ...
    **kwargs,
    ...
    return User.objects.create_user(
        username=default_sequence(username, _username_seq),
        email=default_sequence(email, _email_seq),
