...
class Player:
    ...
    _session_key: str = "player_episode"
    ...
    def get(self) -> int | None:
        ...
        return self._request.session.get(self._session_key)

    def set(self, episode_id: int) -> None:
        """Adds episode PK to player in session."""
        self._request.session[self._session_key] = episode_id
    ...
    def pop(self) -> int | None:
        ...
        return self._request.session.pop(self._session_key, None)
