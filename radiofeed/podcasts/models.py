...
class PodcastQuerySet(FastCountMixin, SearchMixin, models.QuerySet):
    ...
    def scheduled(self) -> models.QuerySet[Podcast]:
        ...
        Scheduling algorithm:
            ...
            4. if podcast was last updated > 24 days, check once every 24 hours

        Note that given volume of podcasts and queueing capacity, podcasts may be not be checked for more than 24 hours.
