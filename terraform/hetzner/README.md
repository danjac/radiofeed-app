...
Option B: Manually copy IPs from `terraform output` to `ansible/hosts.yml`. Update Ansible settings as detailed in `ansible/README.md`.

### 2. Prepare SSH Keys and Certificates
...
### 3. Configure Cloudflare CDN + SSL (Recommended)
