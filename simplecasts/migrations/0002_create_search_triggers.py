...
class Migration(migrations.Migration):
    ...
    operations = [
        # Podcast: owner_search_vector trigger on owner field
        migrations.RunSQL(
            sql="""
