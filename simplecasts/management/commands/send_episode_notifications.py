...
from simplecasts.models import Episode, User
from simplecasts.services.notifications import get_recipients, send_notification_email
        ...
        def _worker(recipient: EmailAddress) -> tuple[EmailAddress, bool]:
            if episodes := self._get_new_episodes(
                ...
                send_notification_email(
                    ...
                    "emails/episode_notifications.html",
                    {
                        "episodes": episodes,
                    },
