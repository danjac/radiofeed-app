...
from simplecasts.episodes.tests.factories import EpisodeFactory
...
from simplecasts.podcasts.parsers.feed_parser import get_categories_dict, parse_feed
from simplecasts.podcasts.parsers.rss_fetcher import make_content_hash
...
class TestFeedParser:
    ...
    def test_parse_same_content(self, mocker):
        ...
        mock_parse_rss = mocker.patch(
            "simplecasts.podcasts.parsers.rss_parser.parse_rss"
        )
