...
from simplecasts.podcasts.admin import (
    ActiveFilter,
    CategoryAdmin,
    FeedStatusFilter,
    PodcastAdmin,
...
from simplecasts.podcasts.models import Category, Podcast, Recommendation, Subscription
...
class TestPodcastAdmin:
    ...
    def test_next_scheduled_update(self, mocker, podcast, podcast_admin):
        mocker.patch(
            "simplecasts.podcasts.admin.Podcast.get_next_scheduled_update",
