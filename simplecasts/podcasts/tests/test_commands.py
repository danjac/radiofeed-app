...
from simplecasts.podcasts.itunes import Feed, ItunesError
...
from simplecasts.users.tests.factories import EmailAddressFactory


class TestParsePodcastFeeds:
    parse_feed = (
        "simplecasts.podcasts.management.commands.parse_podcast_feeds.parse_feed"
    )
...
class TestFetchItunesFeeds:
    mock_fetch = "simplecasts.podcasts.management.commands.fetch_itunes_feeds.itunes.fetch_top_feeds"
    mock_save = "simplecasts.podcasts.management.commands.fetch_itunes_feeds.itunes.save_feeds_to_db"
...
class TestCreatePodcastRecommendations:
    ...
    def test_create_recommendations(self, mocker):
        patched = mocker.patch(
            "simplecasts.podcasts.recommender.recommend",
