...
from simplecasts.tests.asserts import assert200, assert409
from simplecasts.tests.factories import BookmarkFactory, EpisodeFactory, PodcastFactory


class TestBookmarks:
    url = reverse_lazy("bookmarks:bookmarks")
...
class TestAddBookmark:
    ...
    def url(self, episode):
        return reverse("bookmarks:add_bookmark", args=[episode.pk])
...
class TestRemoveBookmark:
    ...
    def test_post(self, client, auth_user, episode):
        ...
        response = client.delete(
            reverse("bookmarks:remove_bookmark", args=[episode.pk]),
