...
urlpatterns = [
    ...
    path("history/<int:episode_id>/complete/", episodes.mark_complete, name="mark_complete"),
    path("history/<int:episode_id>/remove/", episodes.remove_audio_log, name="remove_audio_log"),
    ...
    path("bookmarks/<int:episode_id>/remove/", episodes.remove_bookmark, name="remove_bookmark"),
]
