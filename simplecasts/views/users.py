...
from simplecasts.forms import (
    AccountDeletionConfirmationForm,
    OpmlUploadForm,
    UserPreferencesForm,
)
from simplecasts.http.decorators import require_form_methods
...
from simplecasts.services.opml_parser import parse_opml
...
def user_stats(request: AuthenticatedHttpRequest) -> TemplateResponse:
    ...
    stats = [
        ...
        UserStat(
            ...
            unit="podcast",
            url=reverse("private_feeds:index"),
        ),
        UserStat(
            label="Bookmarks",
