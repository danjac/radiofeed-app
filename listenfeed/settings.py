...
MIDDLEWARE: list[str] = [
    ...
    "listenfeed.middleware.HtmxCacheMiddleware",
    "listenfeed.middleware.HtmxMessagesMiddleware",
    "listenfeed.middleware.HtmxRedirectMiddleware",
    "listenfeed.middleware.SearchMiddleware",
    "listenfeed.episodes.middleware.PlayerMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "listenfeed.context_processors.cache_timeout",
                "listenfeed.context_processors.csrf_header",
            ],
        },
    }
]
...
FORMAT_MODULE_PATH = ["listenfeed.formats"]
...
USER_AGENT = env("USER_AGENT", default="Listenfeed/0.0.0")
...
PWA_CONFIG = {
    "assetlinks": {
        "package_name": env("PWA_PACKAGE_NAME", default="app.listenfeed.twa"),
