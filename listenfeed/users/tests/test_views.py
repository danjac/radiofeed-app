...
from listenfeed.episodes.middleware import PlayerDetails
from listenfeed.episodes.tests.factories import AudioLogFactory, BookmarkFactory
from listenfeed.podcasts.models import Subscription
from listenfeed.podcasts.tests.factories import PodcastFactory, SubscriptionFactory
from listenfeed.tests.asserts import assert200
...
class Test3rdPartyAuthTemplates:
    ...
    def test_template(self, rf, mocker, user, site, template):
        ...
        mocker.patch(
            "listenfeed.users.templatetags.users.get_adapter",
