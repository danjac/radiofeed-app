...
from listenfeed.client import Client
from listenfeed.episodes.models import Episode
from listenfeed.episodes.tests.factories import EpisodeFactory
from listenfeed.feedparser.date_parser import parse_date
from listenfeed.feedparser.feed_parser import get_categories_dict, parse_feed
from listenfeed.feedparser.rss_fetcher import make_content_hash
from listenfeed.podcasts.models import Category, Podcast
from listenfeed.podcasts.tests.factories import PodcastFactory
...
class TestFeedParser:
    ...
    def test_parse_same_content(self, mocker):
        ...
        mock_parse_rss = mocker.patch("listenfeed.feedparser.rss_parser.parse_rss")
