...
from listenfeed.cover_image import (
    CoverImageError,
...
class TestFetchCoverImage:
    ...
    def mock_image(self, mocker):
        ...
        mocker.patch("listenfeed.cover_image.Image.open", return_value=mock_image)
    ...
    def test_chunked_content_too_long(self, mocker):
        ...
        mocker.patch("listenfeed.cover_image.io.BytesIO", return_value=mock_bytesio)
    ...
    def test_image_invalid(self, mocker):
        ...
        mocker.patch(
            "listenfeed.cover_image.Image.open", side_effect=UnidentifiedImageError()
        )
