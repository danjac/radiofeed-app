...
from podtracker.common.email import RqBackend, send_rq_message
...
class TestRqBackend:
    def test_send_messages(self, settings, mocker):
        mock_send_msg = mocker.patch("podtracker.common.email.send_rq_message.delay")
...
class TestSendRqMessage:
    def test_send(self, mocker, message):
        mocker.patch("podtracker.common.email.get_connection")
