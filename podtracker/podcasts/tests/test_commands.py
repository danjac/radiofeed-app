...
from podtracker.podcasts.factories import CategoryFactory, PodcastFactory
from podtracker.podcasts.itunes import Feed
...
class TestCrawlItunes:
    def test_command(self, mocker):
        mock_top_rated = mocker.patch(
            "podtracker.podcasts.itunes.crawl",
            return_value=[
                Feed(
    ...
    def test_exception(self, mocker):
        mocker.patch("podtracker.podcasts.itunes.crawl", side_effect=requests.HTTPError)
