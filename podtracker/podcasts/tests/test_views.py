...
from podtracker.common.asserts import assert_conflict, assert_not_found, assert_ok
...
from podtracker.podcasts.models import Subscription
...
class TestSearchITunes:
    ...
    def test_search_exception(self, client, db, mocker, django_assert_num_queries):
        mock_search = mocker.patch(
            "podtracker.podcasts.itunes.search_cached",
