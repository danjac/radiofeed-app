...
from podtracker.podcasts.tasks import (
    crawl_itunes,
    parse_podcast_feed,
    recommend,
...
class TestTasks:
    ...
    def mock_schedule_primary_feeds(self, mocker):
        return mocker.patch(
            "podtracker.podcasts.tasks.scheduler.schedule_primary_feeds",
            return_value=[1],
        )
    ...
    def mock_schedule_secondary_feeds(self, mocker):
        return mocker.patch(
            "podtracker.podcasts.tasks.scheduler.schedule_secondary_feeds",
            return_value=[1],
        )

    @pytest.fixture
    def mock_parse_podcast_feed(self, mocker):
        return mocker.patch("podtracker.podcasts.tasks.feed_parser.parse_podcast_feed")
    ...
    def test_send_recommendations_emails(self, db, mocker):
        ...
        mocker.patch("podtracker.podcasts.tasks.send_recommendations_email", MockSend)
