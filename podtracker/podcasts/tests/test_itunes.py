...
class TestCrawl:
    def test_crawl(self, mocker):
        ...
        mock_parse = mocker.patch("podtracker.podcasts.itunes.parse_genre")
...
class TestParseGenre:
    ...
    def test_parse(self, mocker, mock_response):
        ...
        mock_fetch = mocker.patch(
            "podtracker.podcasts.itunes.get_podcast", return_value={}
        )
    ...
    def test_lookup_exception(self, mocker, mock_response):
        ...
        mock_fetch = mocker.patch(
            "podtracker.podcasts.itunes.get_podcast", side_effect=requests.HTTPError
        )
