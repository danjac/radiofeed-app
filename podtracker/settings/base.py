...
MIDDLEWARE = [
    ...
    "podtracker.common.middleware.CacheControlMiddleware",
    "podtracker.common.middleware.SearchMiddleware",
    "podtracker.episodes.middleware.PlayerMiddleware",
