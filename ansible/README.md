This directory contains Ansible playbooks for deploying [Listenfeed](https://github.com/danjac/listenfeed-app) to a K3s cluster.
...
1. Ensure you have access to a Listenfeed Docker image. The default image is `ghcr.io/danjac/listenfeed-app`. If this image is not available, you will need to build and push it yourself to a container registry.
