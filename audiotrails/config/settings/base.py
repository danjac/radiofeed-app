...
ROOT_URLCONF = "audiotrails.config.urls"
...
TEMPLATES: list[dict] = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "audiotrails.common.template.context_processors.is_cookies_accepted",
                "audiotrails.common.template.context_processors.search",
            ],
            "builtins": [
                "audiotrails.common.template.defaulttags",
            ],
            "libraries": {
                "pagination": "audiotrails.common.pagination.templatetags",
            },
        },
    }
]
